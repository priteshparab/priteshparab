<!-- Typing Banner -->
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=500&size=28&pause=1000&color=00C7F7&width=750&lines=Hi%2C+I'm+Pritesh+Parab+👋;Bioinformatics+Researcher+🧬;Genomics+%7C+Cancer+Genomics+%7C+RNA-seq+Analysis;Single+Cell+RNA+Sequencing+Explorer;Python+%7C+Machine+Learning+for+Biology;Decode+DNA.+Understand+Life.+⚡)](https://git.io/typing-svg)
...
I work at the intersection of **biology, data science, and programming** to understand complex biological systems using sequencing data.
